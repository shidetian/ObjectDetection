...
std::ostream& 
operator<<(std::ostream& s, const CShape& shape)
{
    s << "(" << shape.width << ", " << shape.height << ", " << shape.nBands << ")";
    return s;
}
...
template<> uchar CImageOf<uchar>::MinVal(void) const  { return 0; }
template<> uchar CImageOf<uchar>::MaxVal(void) const  { return 255; }
template<> int   CImageOf<int  >::MinVal(void) const  { return -1 ^ (1 << 31); }
template<> int   CImageOf<int  >::MaxVal(void) const  { return  0 ^ (1 << 31); }
template<> float CImageOf<float>::MinVal(void) const  { return -FLT_MAX; }
template<> float CImageOf<float>::MaxVal(void) const  { return FLT_MAX; }
